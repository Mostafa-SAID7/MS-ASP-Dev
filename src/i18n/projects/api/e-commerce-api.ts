export const ecommerceApiEN = {
  ...
  liveUrl: "http://e-commerce-api73.runasp.net",
  imageUrl: "/projects/api/E-Commerce API.png",
};
...
export const ecommerceApiAR = {
  ...
  category: "REST API",
  name: "E-Commerce API",
  summary: "واجهة التجارة الإلكترونية REST الكاملة على ASP.NET Core وClean Architecture وSQL Server.",
  year: "٢٠٢٤",
  role: "مهندس Backend",
